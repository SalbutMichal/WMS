...
<div class="app-body-main-content">
    ...
    <section class="warehouse-section">
				...
				<div class="warehouse">
                    <form action="{{ route('dashboard.products.store') }}" method="post" class="warehouse-form">
                        @csrf
                        <div class="warehouse">
                            <dl class="warehouse-details">
                                ...
                                <div>
                                    ...
                                    <dd><input type="text" id="price" name="price" value=""></dd>
                                </div>
                                <div>
                                    <dt><label for="tax">Podatek:</label></dt>
                                    <dd><input type="text" id="tax" name="tax" value=""></dd>
                                </div>
                                <div>
